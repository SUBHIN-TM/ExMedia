        ...
        <>
            ...
            <div className='innerPara grid md:flex   bg-black'>
                ...
                <div className='text-red-600   pt-16 bg-black p-5  w-9/12 flex justify-center items-center'>
                    <div className='brandBox border p-12 '>
            ...
            <div className='innerPara   bg-black'>
                <div className='text-red-600 font-bold text-center text-6xl p-5'>WHO WE ARE</div>
            ...
            <div className=' grid md:flex   bg-white'>
                <div className='text-white w-3/4  p-5'  > <img src={studio} alt="" />  </div>
            ...
            <div className=' grid md:flex   bg-white'>
                <div className='text-white w-3/4  p-5'  > <img src={robotic} alt="" />  </div>
                <div className='text-red-600   pt-2 bg-black p-5  w-9/12 '>
            ...
            <div className=' grid md:flex   bg-white'>
                <div className='text-white w-3/4  p-5'  > <img src={fingers} alt="" />  </div>
                <div className='text-red-600   pt-2 bg-black p-5  w-9/12 '>
